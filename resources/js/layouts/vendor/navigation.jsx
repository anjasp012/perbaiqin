                    ...
                    {auth.vendor ? (
                        <DropdownMenu>
                            <DropdownMenuTrigger className={cn(buttonVariants({ size: 'sm' }), 'tracking-tighter')}>
                                {auth.vendor.name} <ChevronDown className="ml-2 h-4 w-4 transition-transform duration-300 group-data-[state=open]:rotate-180" />
                            </DropdownMenuTrigger>
                            <DropdownMenuContent align="end" className="w-60">
                                ...
                                <DropdownMenuItem onSelect={() => router.post(route('vendor.logout'))}>
...
const navLinks = [
    ...
    { label: 'My Products', route: 'vendor.products.index' },
    { label: 'Transaction', route: 'vendor.transactions.index' },
];
