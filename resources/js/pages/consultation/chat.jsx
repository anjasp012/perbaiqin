...
import { ChatLayout } from '@/layouts/user/chat/chat-layout';
import { ChatNav } from '@/layouts/user/chat/chat-nav';
...
const ChatRoom = () => {
    ...
    const initializeEcho = () => {
        ...
        if (echoInstance) {
            echoInstance.channel(`consultation.${consultation.id}`).listen('.consultation-send', (data) => {
            ...
            <div className="grid-1 grid ">
                <div className="flex h-screen w-full flex-col">
                    ...
                    <ScrollArea className="flex-1 overflow-y-auto px-4">
                        <div className="mt-4 px-3" style={{ minHeight: 'calc(100vh - 10rem)' }}>
