...
import ReportModal from '@/pages/articles/partials/report-modal';

export function CommentOptions({ auth, article, comment }) {
    const { ask } = useSwal();
        ...
        <Menu as="div" className="relative inline-block text-left">
            <div>
                <Menu.Button className="flex justify-end">
                    <EllipsisVerticalIcon className="-mr-1 h-5 w-5 text-muted-foreground" aria-hidden="true" />
                </Menu.Button>
            </div>
