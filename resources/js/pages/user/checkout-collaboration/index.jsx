...
export default function CheckoutIndex() {
    const { auth, collaboration, subTotal } = usePage().props;
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('user.checkout.checkoutCollaborationNow', collaboration.id));
    };
    return (
        <>
            <Head title="My Cart Collaboration" />
                            ...
                            <ul role="list" class="divide-y text-sm font-medium">
                                <li className="flex items-start space-x-4 py-6">
                                    ...
                                    <div class="flex-auto space-y-2">
                                        <h3 class="text-base font-medium">{collaboration.name}</h3>
                                        <div class="text-[0.85rem] font-normal capitalize text-muted-foreground">
                                            <p className="text-red-600">{collaboration.technician.name}</p>
                                        </div>
                                    </div>
                                    <p class="flex-none text-base font-medium">{formatRupiah(collaboration.price)}</p>
                                </li>
                            </ul>
