...
export default function SpecialistCreate() {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('admin.specialists.store'), formData); // Mengirimkan formData
    };
            ...
            <Container>
                <div className="px-4 py-6 sm:px-6 lg:p-8">
                    <div className="mb-8 flex items-center justify-between">
                        <h1 className="text-xl font-semibold">Create Specialist</h1>
                    </div>
...
SpecialistCreate.layout = (page) => <AdminLayout children={page} />;
